...
export const Footer = () => {
  ...
  <h1 className="mx-4 text-2xl font-extrabold bg-gradient-to-r from-emerald-500 to-emerald-300 bg-clip-text text-transparent">
  ...
  <a href="#" className="text-white/70 hover:text-white text-xs md:text-sm flex items-center gap-2 transition">
  ...
  <a href="#" className="text-white/70 hover:text-white text-xs md:text-sm flex items-center gap-2 transition">
    ...
    Shibansh Behera
      ...
      <div className="py-8 inline-flex gap-5 lg:flex-1">
       <a href="" className="text-white/40 hover:text-white transition h-6 w-6"><GitH /></a> 
